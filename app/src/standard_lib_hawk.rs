...
"e" => Some(Object::Function{params: vec!["x"].iter().map(|x| x.to_string()).collect(), block: Box::new(Statement::Block(vec![Statement::Return(Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("eNum".to_string()))), operand2: Box::new(Expression::Literal(Object::Identifier("x".to_string()))), operator: TokenType::Caret})),
]))}),
...
Statement::Definition{name: "i".to_string(), value: Box::new(Expression::Literal(Object::Int(1)))},
Statement::IfElse{condition: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("x".to_string()))), operand2: Box::new(Expression::Literal(Object::Int(0))), operator: TokenType::GreaterThan}), if_block: Box::new(Statement::Block(vec![Statement::While{condition: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("x".to_string()))), operand2: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Int(2))), operand2: Box::new(Expression::Literal(Object::Identifier("pi".to_string()))), operator: TokenType::Asterisk}), operator: TokenType::GreaterThan}), block: Box::new(Statement::Block(vec![Statement::Definition{name: "x".to_string(), value: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("x".to_string()))), operand2: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Int(2))), operand2: Box::new(Expression::Literal(Object::Identifier("pi".to_string()))), operator: TokenType::Asterisk}), operator: TokenType::Minus})},
]))},
])), else_block: Box::new(Statement::Block(vec![Statement::While{condition: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("x".to_string()))), operand2: Box::new(Expression::Unary{operand: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Int(2))), operand2: Box::new(Expression::Literal(Object::Identifier("pi".to_string()))), operator: TokenType::Asterisk}), operator: TokenType::Minus}), operator: TokenType::LessThan}), block: Box::new(Statement::Block(vec![Statement::Definition{name: "x".to_string(), value: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("x".to_string()))), operand2: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Int(2))), operand2: Box::new(Expression::Literal(Object::Identifier("pi".to_string()))), operator: TokenType::Asterisk}), operator: TokenType::Plus})},
]))},
]))},
...
"cos" => Some(Object::Function{params: vec!["x"].iter().map(|x| x.to_string()).collect(), block: Box::new(Statement::Block(vec![Statement::Return(Box::new(Expression::FunctionCall{identifier: "sin".to_string(), args: vec![Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("x".to_string()))), operand2: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("pi".to_string()))), operand2: Box::new(Expression::Literal(Object::Int(2))), operator: TokenType::Slash}), operator: TokenType::Plus})
]})),
]))}),
...
"sinh" => Some(Object::Function{params: vec!["x"].iter().map(|x| x.to_string()).collect(), block: Box::new(Statement::Block(vec![Statement::Return(Box::new(Expression::Binary{operand1: Box::new(Expression::Binary{operand1: Box::new(Expression::FunctionCall{identifier: "e".to_string(), args: vec![Box::new(Expression::Literal(Object::Identifier("x".to_string())))
]}), operand2: Box::new(Expression::FunctionCall{identifier: "e".to_string(), args: vec![Box::new(Expression::Unary{operand: Box::new(Expression::Literal(Object::Identifier("x".to_string()))), operator: TokenType::Minus})
