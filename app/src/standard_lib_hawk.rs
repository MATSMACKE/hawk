...
"e" => Some(Object::Function{params: Vec::new(), block: Box::new(Statement::Return(Box::new(Expression::Literal(Object::Float(2.7182818284590455)))))}),
...
"ln" => Some(Object::Function{params: vec!["x"].iter().map(|x| x.to_string()).collect(), block: Box::new(Statement::Block(vec![Statement::Definition{name: "decimal".to_string(), value: Box::new(Expression::Literal(Object::Int(0)))},
Statement::While{condition: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("x".to_string()))), operand2: Box::new(Expression::Literal(Object::Int(1))), operator: TokenType::GreaterThan}), block: Box::new(Statement::Block(vec![Statement::Definition{name: "x".to_string(), value: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("x".to_string()))), operand2: Box::new(Expression::Literal(Object::Int(10))), operator: TokenType::Slash})},
Statement::Definition{name: "decimal".to_string(), value: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("decimal".to_string()))), operand2: Box::new(Expression::Literal(Object::Int(1))), operator: TokenType::Plus})},
]))},
Statement::Definition{name: "sum".to_string(), value: Box::new(Expression::Literal(Object::Int(0)))},
...
Statement::Definition{name: "i".to_string(), value: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("i".to_string()))), operand2: Box::new(Expression::Literal(Object::Int(1))), operator: TokenType::Plus})},
]))},
