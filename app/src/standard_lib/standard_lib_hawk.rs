...
"sin" => Some(Object::Function{params: vec!["x"].iter().map(std::string::ToString::to_string).collect(), block: Box::new(Statement::Block(vec![Statement::Definition{name: "sum".to_owned(), value: Box::new(Expression::Literal(Object::Int(0)))},
Statement::Definition{name: "i".to_owned(), value: Box::new(Expression::Literal(Object::Int(1)))},
Statement::IfElse{condition: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("x".to_owned()))), operand2: Box::new(Expression::Literal(Object::Int(0))), operator: TokenType::GreaterThan}), if_block: Box::new(Statement::Block(vec![Statement::While{condition: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("x".to_owned()))), operand2: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Int(2))), operand2: Box::new(Expression::FunctionCall{identifier: "pi".to_owned(), args: vec![Box::new(Expression::Literal(Object::Null)),
]}), operator: TokenType::Asterisk}), operator: TokenType::GreaterThan}), block: Box::new(Statement::Block(vec![Statement::Definition{name: "x".to_owned(), value: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("x".to_owned()))), operand2: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Int(2))), operand2: Box::new(Expression::FunctionCall{identifier: "pi".to_owned(), args: vec![Box::new(Expression::Literal(Object::Null)),
]}), operator: TokenType::Asterisk}), operator: TokenType::Minus})},
]))},
])), else_block: Box::new(Statement::Block(vec![Statement::While{condition: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("x".to_owned()))), operand2: Box::new(Expression::Unary{operand: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Int(2))), operand2: Box::new(Expression::FunctionCall{identifier: "pi".to_owned(), args: vec![Box::new(Expression::Literal(Object::Null)),
]}), operator: TokenType::Asterisk}), operator: TokenType::Minus}), operator: TokenType::LessThan}), block: Box::new(Statement::Block(vec![Statement::Definition{name: "x".to_owned(), value: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("x".to_owned()))), operand2: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Int(2))), operand2: Box::new(Expression::FunctionCall{identifier: "pi".to_owned(), args: vec![Box::new(Expression::Literal(Object::Null)),
]}), operator: TokenType::Asterisk}), operator: TokenType::Plus})},
]))},
]))},
Statement::While{condition: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("i".to_owned()))), operand2: Box::new(Expression::Literal(Object::Int(20))), operator: TokenType::LessThan}), block: Box::new(Statement::Block(vec![Statement::Definition{name: "sum".to_owned(), value: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("sum".to_owned()))), operand2: Box::new(Expression::Binary{operand1: Box::new(Expression::Binary{operand1: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("x".to_owned()))), operand2: Box::new(Expression::Literal(Object::Identifier("i".to_owned()))), operator: TokenType::Caret}), operand2: Box::new(Expression::Binary{operand1: Box::new(Expression::Unary{operand: Box::new(Expression::Literal(Object::Int(1))), operator: TokenType::Minus}), operand2: Box::new(Expression::Binary{operand1: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("i".to_owned()))), operand2: Box::new(Expression::Literal(Object::Int(1))), operator: TokenType::Minus}), operand2: Box::new(Expression::Literal(Object::Int(2))), operator: TokenType::Slash}), operator: TokenType::Caret}), operator: TokenType::Asterisk}), operand2: Box::new(Expression::FunctionCall{identifier: "factorial".to_owned(), args: vec![Box::new(Expression::Literal(Object::Identifier("i".to_owned()))),
]}), operator: TokenType::Slash}), operator: TokenType::Plus})},
Statement::Definition{name: "i".to_owned(), value: Box::new(Expression::Binary{operand1: Box::new(Expression::Literal(Object::Identifier("i".to_owned()))), operand2: Box::new(Expression::Literal(Object::Int(2))), operator: TokenType::Plus})},
]))},
Statement::Return(Box::new(Expression::Literal(Object::Identifier("sum".to_owned())))),
]))}),
