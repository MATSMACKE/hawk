import { print, warn, error, writefile, readfile } from './../hawk_interface.ts';
...
export class Runner {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Runner.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_runner_free(ptr);
    }
    /**
    * @returns {Runner}
    */
    static new() {
        var ret = wasm.runner_new();
        return Runner.__wrap(ret);
    }
    /**
    */
    clear() {
        wasm.runner_clear(this.ptr);
    }
    /**
    * @param {string} code
    ...
    */
    run(code, in_repl) {
        ...
        wasm.runner_run(this.ptr, ptr0, len0, in_repl);
    }
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('hawk_wasm_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
